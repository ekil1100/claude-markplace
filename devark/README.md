# devark — ets_runtime TDD Development Plugin

Claude Code 插件，用于 ets_runtime 通用开发的 TDD 编排。
...
在 Claude Code 中使用 `/devark` 触发，或在 ets_runtime 项目目录下进行开发时自动触发。
...
devark/
├── README.md                # 本文件
├── skills/devark/SKILL.md   # Planner 主流程
├── agents/
